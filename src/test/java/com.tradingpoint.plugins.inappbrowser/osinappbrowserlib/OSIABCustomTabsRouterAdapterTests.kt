...
import com.tradingpoint.plugins.inappbrowser.osinappbrowserlib.helpers.OSIABCustomTabsSessionHelperMock
...
class OSIABCustomTabsRouterAdapterTests {
    ...
    private val uri = Uri.parse("https://www.tradingpoint.com/")
