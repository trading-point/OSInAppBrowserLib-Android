...
import com.tradingpoint.plugins.inappbrowser.osinappbrowserlib.views.OSIABWebViewActivity
...
sealed class OSIABEvents {
    ...
    companion object {
        const val EXTRA_BROWSER_ID = "com.tradingpoint.plugins.inappbrowser.osinappbrowserlib.EXTRA_BROWSER_ID"
